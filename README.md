...
![Continuous Integration](https://github.com/nholuongut/microservices-demo-sample/workflows/Continuous%20Integration%20-%20Main/Release/badge.svg)
...
2. Clone the latest major version.
   ...
   ```sh
   git clone --depth 1 --branch v0 https://github.com/nholuongut/microservices-demo-sample.git
