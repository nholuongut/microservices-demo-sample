...
This page walks you through the steps required to deploy the [Online Boutique](https://github.com/nholuongut/microservices-demo-sample) sample application on a [Google Kubernetes Engine (GKE)](https://cloud.google.com/kubernetes-engine) cluster using Terraform.
...
1. Clone the Github repository.
    ...
    ```bash
    git clone https://github.com/nholuongut/microservices-demo-sample.git
    ```
